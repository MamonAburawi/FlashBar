...
import com.info.flashbar.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViews() {
        binding.apply {
            ...
            /** button show flash bar **/
            btnShowFlashBar.setOnClickListener {
            ...
            /** button hide flash bar **/
            btnHideFlashBar.setOnClickListener {
                flashBar?.dismiss()
            }
    ...
    private fun messageAdvanced(): Flashbar {
        return Flashbar.Builder(this@MainActivity)
            .gravity(Flashbar.Gravity.TOP)
            .title("Hello World")
